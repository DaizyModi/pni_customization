		...
		"filters": [
			[
				"fieldname", "in", (
					...
					"is_paper_plate", "quotation_tables_section", "quotation_table", "supplier_quotation_tables_section",
					"supplier_quotation_table", "paper_plate", "reel_item", "reel_brand", "reel_size", "reel_gsm",
