        ...
        "filters": [
            [
                "fieldname", "in", (
                    ...
                    "j_city", "j_area", "j_brancharea", "j_dncmobile", "j_dncphone", "j_company", "j_pincode", "j_time", "j_branchpin", "j_parentid", "pni_sales_order_item", "item_filter", "add_pni_bag", "weight_filter", "section_pni_settings", "section_pni_packing_table", "pni_clm_brk", "is_paper_cup", "pni_item_code", "approve_law_rate__", "need_approval", "tear_weight", "unit_price_pni", "pni_rejected_qty", "pni_rework_qty", "pni_carton_in_section", "pni_carton_in", "pni_packing_carton", "carton_item", "pni_carton_out_data", "shift", "customer_outstanding", "total_customer_outstanding", "packing_type", "pnicbc", "supervisor", "supervisor_name", "conversation_factor", "pni_bag_in", "carton_warehouse", "pni_bag_out_data", "bag_item", "punching_die", "pni_cbc2", "bag_brand", "coated_real", "printed_reel", "bag_warehouse", "workstation_head", "workstation_head_name", "main_category", "main_category_code", "sub_category", "sub_category_code", "work_station_head", "pni_shift", "machine_helper", "workstation_pni", "skip_pni_quality_inspection", "same_price_purchase", "stock_short", "skip_short_stock", "short_closed", "setup_time", "pni_programme_cycle_time", "skip_restriction", "employee_onboarding", "repair_job_work_transfer_entry", "stock_entry_data", "pnicbc2", "pni_address", "pni_address_display", "reference_name", "job_application", "employee_onboarding_process", "skip_workflow_validation", "pni_gate_entry", "leave_allocation_not_applicable", "pni_rate", "skip_supplier_item_validation", "pni_setup_rejection_qty", "extra_charges", "purchase_executive", "employee_shift_type", "shift_array", "total_hours"
                )
            ]
        ]
    }
...
doc_events = {
    ...
    "Shift Type": {
        "validate": "pni_customization.utility.shift_type_utility.shift_type_validate"
    }
}
...
doctype_js = {
    ...
    "Purchase Receipt": "public/js/item_add.js",
